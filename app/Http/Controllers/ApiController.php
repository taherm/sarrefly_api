...
class ApiController extends Controller
{
    ...
    {
        $val = \App\User::all()->where('name', $request->name)->where('password', $request->password)->first();
