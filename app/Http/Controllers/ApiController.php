...
class ApiController extends Controller
{
    ...
    {
        $order_name_exists = Order::where('receiver_name', $request->receiver_name)->get();
        if ($order_name_exists) {
            $order = Order::create($request->except('saved'))->id;
        } else {
